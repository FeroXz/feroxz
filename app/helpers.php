<?php
function share_view_data(array $data): void
{
    if (!isset($GLOBALS['sharedViewData'])) {
        $GLOBALS['sharedViewData'] = [];
    }
    $GLOBALS['sharedViewData'] = array_merge($GLOBALS['sharedViewData'], $data);
}
