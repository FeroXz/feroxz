            ...
            <tbody>
                <?php foreach ($users as $user): ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-secondary" href="<?= route_url('admin/users', ['edit' => $user['id']]) ?>">Bearbeiten</a>
                            <?php if ($user['id'] !== current_user()['id']): ?>
                                <a class="btn btn-secondary" href="<?= route_url('admin/users', ['delete' => $user['id']]) ?>" onclick="return confirm('Benutzer löschen?');">Löschen</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
