...
<head>
    ...
    $siteTagline = settingValue($settings, 'site_tagline', 'Reptilienverwaltung & Genetik');
...
<footer class="site-footer">
    <div class="container">
        <p><?= nl2br(htmlspecialchars(settingValue($settings, 'footer_text', '&copy; ' . date('Y') . ' ' . $siteTitle))) ?></p>
