...
<section class="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
    <header class="max-w-3xl">
        <span class="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs font-semibold uppercase tracking-[0.25em] text-slate-300">Intern</span>
        <h1 class="mt-4 text-3xl font-semibold text-white sm:text-4xl">Meine Tiere</h1>
        <p class="mt-2 text-sm text-slate-300">Nur du kannst diese Tiere sehen. Bearbeitungen erfolgen im Adminbereich.</p>
    </header>
    <?php if (empty($animals)): ?>
        <div class="mt-10 rounded-3xl border border-white/10 bg-night-900/75 p-8 text-center text-sm text-slate-300">
